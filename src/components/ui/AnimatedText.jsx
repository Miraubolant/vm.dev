              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-primary-dark border border-electric-blue rounded-lg text-white focus:border-neon-red focus:ring-1 focus:ring-neon-red transition-colors cursor-text caret-white"
                    style={{ caretColor: '#E94560', fontSize: '16px' }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-primary-dark border border-electric-blue rounded-lg text-white focus:border-neon-red focus:ring-1 focus:ring-neon-red transition-colors cursor-pointer caret-white"
                    style={{ caretColor: '#E94560', fontSize: '16px' }}
                  >
